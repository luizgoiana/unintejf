...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'uninterjf', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'/src/AdminBundle/Resources/config/doctrine') => 'AdminBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_381741ff45877d96187c4422927e6fc677d9a0dd77661df5670e67ebbbd4bdec');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/SobreBundle/Resources/views'), 'Sobre');
        $instance->addPath(($this->targetDirs[3].'/src/EspecialidadeBundle/Resources/views'), 'Especialidade');
        $instance->addPath(($this->targetDirs[3].'/src/EstruturaBundle/Resources/views'), 'Estrutura');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SobreBundle' => 'SobreBundle\\SobreBundle',
                'EspecialidadeBundle' => 'EspecialidadeBundle\\EspecialidadeBundle',
                'EstruturaBundle' => 'EstruturaBundle\\EstruturaBundle',
