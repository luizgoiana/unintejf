 ...
 */
class Especialidade extends \AdminBundle\Entity\Especialidade implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AdminBundle\\Entity\\Especialidade' . "\0" . 'titulo', '' . "\0" . 'AdminBundle\\Entity\\Especialidade' . "\0" . 'descricao', '' . "\0" . 'AdminBundle\\Entity\\Especialidade' . "\0" . 'imagem', '' . "\0" . 'AdminBundle\\Entity\\Especialidade' . "\0" . 'id');
        }
