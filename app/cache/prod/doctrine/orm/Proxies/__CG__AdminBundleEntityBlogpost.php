 ...
 */
class Blogpost extends \AdminBundle\Entity\Blogpost implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AdminBundle\\Entity\\Blogpost' . "\0" . 'post', '' . "\0" . 'AdminBundle\\Entity\\Blogpost' . "\0" . 'tags', '' . "\0" . 'AdminBundle\\Entity\\Blogpost' . "\0" . 'image', '' . "\0" . 'AdminBundle\\Entity\\Blogpost' . "\0" . 'titulo', '' . "\0" . 'AdminBundle\\Entity\\Blogpost' . "\0" . 'date', '' . "\0" . 'AdminBundle\\Entity\\Blogpost' . "\0" . 'id');
        }
