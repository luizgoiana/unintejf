 ...
 */
class Estrutura extends \AdminBundle\Entity\Estrutura implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AdminBundle\\Entity\\Estrutura' . "\0" . 'imagepath', '' . "\0" . 'AdminBundle\\Entity\\Estrutura' . "\0" . 'id');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Estrutura $proxy) {
